...
void frmMain::updateControlsState() {
    ...
    ui->grpProgram->setProperty("overridden", m_heightMapMode);
...
void frmMain::on_cmdSpindle_toggled(bool checked) {
    ui->grpSpindle->setProperty("overridden", checked);
...
void frmMain::onOverridingToggled(bool checked) {
    ...
    ui->grpOverriding->setProperty("overridden", ui->slbFeedOverride->isChecked() || ui->slbRapidOverride->isChecked() ||
                                                ui->slbSpindleOverride->isChecked());
